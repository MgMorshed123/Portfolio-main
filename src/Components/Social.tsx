...
const Social = () => {
  ...
  return (
    <div className="flex md-mx:hidden text-textColor items-center gap-8 fixed bottom-32 -left-56 rotate-90 ">
      {socialIcons}
      <hr className="border w-96 rounded-full  bg-textColor border-textColor" />
    </div>
  );
};
